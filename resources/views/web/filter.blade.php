                ...
                <form action="{{ route('web.filter') }}" method="post" class="w-100 p-3 bg-white mb-5">
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            <label for="filter_search" class="mb-2 text-front">Comprar ou Alugar?</label>
                        ...
                        <div class="form-group col-12">
                            <label for="filter_type" class="mb-2 text-front">Qual o tipo do imóvel?</label>
                        ...
                        <div class="form-group col-12">
                            ...
                            <select class="selectpicker" name="filter_limit" id="limit" title="Escolha..." data-index="10" data-action="{{ route('component.main-filter.limit') }}">
                                <option disabled>Selecione o filtro anterior</option>
                            </select>
                        </div>
