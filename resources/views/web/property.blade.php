            ...
            <div class="row">
                        ...
                        <ol class="carousel-indicators">
                            @if($property->images()->get()->count())
                                @foreach ($property->images()->get() as $image)
                                    <li data-target="#carouselProperty" data-slide-to="{{ $loop->iteration -1 }}" {!! ($loop->iteration == 1 ? 'class="active"' : '') !!}></li>
                                @endforeach
                            @endif
                        </ol>
                        ...
                        <div class="row">
                            @if($property->facilities->count())
                                @foreach($property->facilities as $facility)
                                    <span class="main_property_structure_item icon-check">{{ $facility->description_translate }}</span>
                                @endforeach
                            @endif
                        </div>
                    </div>
                ...
                <div class="col-12 col-lg-4">
                    ...
                    <div class="main_property_share py-3 text-right d-flex justify-content-center">
                        ...
                        <a style="padding: 0 10px; margin: 0; font-size: 0.875em; padding-top: 2px;" href="" class="btn btn-front icon-instagram ml-2">Instagram</a>
                    </div>
                </div>
            </div>
        </div>
...
<div id="fb-root"></div>
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v8.0" nonce="BruPUdDN"></script>
