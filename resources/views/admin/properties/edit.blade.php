                        ...
                        <div class="label_g2">
                            <label class="label">
                                ...
                                <select name="category" class="select2">
                                    ...
                                    <option value="Comercial/Industrial" {{ (old('rent') == 'Comercial/Industrial' ? 'selected' : ($property->category == 'Comercial/Industrial' ? 'selected' : '')) }}>Comercial/Industrial</option>
                                    <option value="Terreno" {{ (old('rent') == 'Terreno' ? 'selected' : ($property->category == 'Terreno' ? 'selected' : '')) }}>Terreno</option>
                                </select>
                            </label>
                    ...
                    <div id="structure" class="d-none">
                        ...
                        <div class="label_g5">
                            @foreach($facilities as $fac)
                                @if(!empty($propertyFacilities->firstWhere('id', $fac->id)))
                                    <div>
                                        <label class="label">
                                            <input type="checkbox" name="{{ $fac->description }}" {{'checked'}}><span>{{ $fac->description_translate }}</span>
                                        </label>
                                    </div>
                                @else
                                    <div>
                                        <label class="label">
                                            <input type="checkbox" name="{{ $fac->description }}" {{ old($fac->description) == 'on' || old($fac->description) == true ? 'checked' : '' }}><span>{{ $fac->description_translate }}</span>
                                        </label>
                                    </div>
                                @endif
                            @endforeach
...
<script>
    $(function () {
        ...
        $('.image-set-cover').click(function(){
