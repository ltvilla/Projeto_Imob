                    ...
                    <div id="data">
                        ...
                        <div class="label_g2">
                            <label class="label">
                                ...
                                <select name="category" class="select2">
                                    ...
                                    <option value="Comercial/Industrial" {{ old('rent') == 'Comercial/Industrial' ? 'selected' : '' }}>Comercial/Industrial</option>
                                    <option value="Terreno" {{ old('rent') == 'Terreno' ? 'selected' : '' }}>Terreno</option>
                                </select>
                            </label>
                            ...
                            <label class="label">
                                ...
                                <select name="type" class="select2">
                                    ...
                                    <optgroup label="Terreno">
                                        <option value="Terreno" {{ old('type') == 'terrain' ? 'selected' : '' }}>Terreno</option>
                                    </optgroup>
                                </select>
                            </label>
                        </div>
                        ...
                        <label class="label">
                            ...
                            <select name="user" class="select2">
                                <option value="1">Nome (documento)</option>
