        ...
        <article class="dash_login_left_box">
            ...
            <form name="login" action="{{ route('admin.login.do') }}" method="post" autocomplete="off">
                <label>
                    ...
                    <input type="email" name="email" placeholder="Informe seu e-mail" value="tiago_villa1@hotmail.com" required/>
                </label>

                <label>
                    <span class="field icon-unlock-alt">Senha:</span>
                    <input type="password" name="password_check" placeholder="Informe sua senha" required</input>
                </label>
