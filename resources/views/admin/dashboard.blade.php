    ...
    <section class="dash_content_app" style="margin-top: 40px;">
        ...
        <div class="dash_content_app_box">
            ...
            <table id="dataTable" class="nowrap hover stripe" width="100" style="width: 100% !important;">
                ...
                <tr>
                    <td><a href="{{ route('admin.contracts.edit', ['contract' => $contract->id]) }}" class="text-orange">{{ $contract->id }}</a>
                    <td><a href="{{ route('admin.users.edit', ['user' => $contract->owner]) }}" class="text-orange">{{ $contract->OwnerObject->name }}</a></td>
                    <td><a href="{{ route('admin.users.edit', ['user' => $contract->acquirer]) }}" class="text-orange">{{ $contract->AcquirerObject->name }}</a></td>
                    ...
                    @if(!empty($properties))
                        ...
                        <div class="realty_list_item mb-2">
                            <div class="realty_list_item_actions_stats">
                                ...
                                <ul>
                                    @if($property->sale == true && !empty($property->rent_price))
                            ...
                            <div class="realty_list_item_content">
                                <h4>#{{ $property->id }}  {{ $property->type }} {{ $property->category }}</h4>
                                ...
                                <div class="realty_list_item_card">
                                    ...
                                    <div class="realty_list_item_card_content">
                                        ...
                                        <span class="realty_list_item_description_content">{{ $property->area_util }};</span>
                                    </div>
                                </div>
