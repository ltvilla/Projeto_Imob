...
class WebController extends Controller
{
    public function home()
    {
        $head = $this->seo->render(
            ...
            'Encontre o imóvel dos seus sonhos na melhor e mais completa imobiliária do Sul!', 
            route('web.home'),
    ...
    public function rent()
    {
        $head = $this->seo->render(
            env('APP_NAME') . ' - UpInside Treinamentos', 
            'Alugue o imóvel dos seus sonhos na melhor e mais completa imobiliária do Sul!', 
            route('web.rent'),
            asset('frontend/assets/images/share.png')
        );
    ...
    {
        $property = Property::where('slug', $request->slug)->with('facilities')->first();
    ...
    public function buy()
    {
        $head = $this->seo->render(
            env('APP_NAME') . ' - UpInside Treinamentos', 
            'Compre o imóvel dos seus sonhos na melhor e mais completa imobiliária do Sul!', 
            route('web.buy'),
            asset('frontend/assets/images/share.png')
        );
    ...
    public function filter()
    {
        $head = $this->seo->render(
            env('APP_NAME') . ' - UpInside Treinamentos', 
            'Filtre o imóvel dos seus sonhos na melhor e mais completa imobiliária do Sul!', 
            route('web.filter'),
            asset('frontend/assets/images/share.png')
        );
    ...
    public function experience()
    {
        $head = $this->seo->render(
            env('APP_NAME') . ' - UpInside Treinamentos', 
            'Viva a esperiência de encontrar o imóvel dos seus sonhos na melhor e mais completa imobiliária do Sul!', 
    ...
    public function experienceCategory(Request $request)
    {
        $head = $this->seo->render(
            env('APP_NAME') . ' - UpInside Treinamentos', 
            $request->slug . '......', 
            route('web.experienceCategory', ['category' => $request->slug]),
            asset('frontend/assets/images/share.png')
        );
    ...
    public function contact()
    {
        $head = $this->seo->render(
            env('APP_NAME') . ' - UpInside Treinamentos', 
            'Quer conversar com um corretor exclusivo e ter o atendimento diferenciado em busca do seu imóvel dos sonhos? Entre em contato com nosso time', 
            route('web.contact'),
            asset('frontend/assets/images/share.png')
        );
